...
export default class Redis {
  ...
  private parseKey(messageKey: Buffer | null): any {
    // change the any!
    if (messageKey === null) {
      return null;
    }
  ...
  private parseValue(messageValue: Buffer | null): any {
    // change the any!
  ...
  private determineOperation(parsedMessageValue: any): any {
    // need to change the any return type AND have the correct parsedMessage argument type
  ...
  private determineRedisKey(parsedMessageKey: any): string {
    // need to change the any return type AND have the correct parsedMessage argument type
